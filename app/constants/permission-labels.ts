...
export const PERMISSION_CATEGORY_SECTION_TITLES: Record<string, string> = {
  ...
  workflow: 'Workflow y bandeja de tareas',
  expedientes: 'Expedientes electrónicos y gestión documental',
  comunicados: 'Comunicados internos',
...
const PERMISSION_LABEL_OVERRIDES: Record<string, string> = {
  ...
  radicacion_trasladar_sucursal: 'Trasladar radicación a otra sucursal',
